<div class="btn-group product-product">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tax]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.tax')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[tax]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[stock_status]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.stock_status')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[stock_status]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[discount]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.discount')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[discount]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".product-product .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/product.product.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".product-product .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.product-product .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'product.product.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#product-product-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#product-product-list .btn-reset-filter').css('display', 'none');
