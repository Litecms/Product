<div class="btn-group product-category">
...
$(document).ready(function(){
    ...
    $(".product-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/product.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".product-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.product-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'product.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#product-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#product-category-list .btn-reset-filter').css('display', 'none');
