<div class="btn-group product-order">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[track_status]" class="col-sm-2 control-label">
                                        {!! trans('product::order.label.track_status')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[track_status]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[subtotal]" class="col-sm-2 control-label">
                                        {!! trans('product::order.label.subtotal')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[subtotal]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[payment_status]" class="col-sm-2 control-label">
                                        {!! trans('product::order.label.payment_status')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[payment_status]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".product-order .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/product.order.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".product-order .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.product-order .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'product.order.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#product-order-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#product-order-list .btn-reset-filter').css('display', 'none');
