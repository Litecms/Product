...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('product.category.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        return  $user->canDo('product.category.create');
    }
    ...
    {
        if ($user->canDo('product.category.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('product.category.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('product.category.approve')) {
            return true;
        }
