...
namespace Litecms\Product\Http\Requests;
...
class OrderRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('order');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access order module,
    ...
    {
        return user()->canDo('product.order.view');
    }
}
